...
public class Polynomial extends ArrayList<Integer> {
    ...
    */
	...
	int [] newLowToHigh = new int [coeffsHighToLow.length];
	for (int i = 0; i<coeffsHighToLow.length; i++) {
	    newLowToHigh[coeffsHighToLow.length-i-1] = coeffsHighToLow[i];
	}
	return newLowToHigh;
    }
    ...
    */
	...
	int [] newHighToLow = new int [coeffsLowToHigh.length];
	for (int i = 0; i<coeffsLowToHigh.length; i++) {
	    newHighToLow[coeffsLowToHigh.length-i-1] = coeffsLowToHigh[i];
	}
	return newHighToLow;
    }
